...
<head lang="en">
    ...
    <title>作者收入-览书网作者中心</title>
    <link rel="Shortcut Icon" href="../img/slogo.ico" >
    <link rel="stylesheet" href="../css/author.css"/>
    <link rel="stylesheet" href="../css/authorSale.css"/>
...
<article class="auto">
    ...
    <div class="side">
        <ul>
            ...
            <li class="incomes current"><h4><em></em><a href="authorSale.jsp">我的收入</a></h4></li>
...
<script src="../js/authorSale.js"></script>
</html>