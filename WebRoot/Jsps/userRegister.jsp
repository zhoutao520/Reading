                ...
                <div class="reg">
                    <div class="reg-form" v-if="act">
                        <dl>
                            ...
                            <dd>
                                <em>密码</em>
                                <input type="password" v-model.lazy="pwd" placeholder="6-18位英文字母及数字" :class="error[2].flag?'error':''"><span v-text="error[2].pwd"></span>    
                            </dd>
                            <dd>
                                <em>确认密码</em>
                    ...
                    <div class="reg-success" v-else="!act">
                        ...
                        <p class="jump"><span v-text="sec"></span>秒后即将跳转至首页</p>
                    </div>
                </div>
            </div>
        </div>
