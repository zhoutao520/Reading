...
<div class="box auto">
	<p class="tip">“<span v-text="search"></span>”的搜索结果:</p>
	<ul>
		<li v-for="item in books" @click="bookInfo(item.bookId)">
			<div class="book-img">
				<img :src="item.cover" >
			</div>
			<div class="info">
				<h4 v-text="item.bookName"></h4>
				<p class="author">
	...
	<p v-if="bookSize>20&&bookSize!=books.length" @click="load()" class="load">加载更多...</p>
</div>
<div class="login">
