...
<head lang="en">
    ...
    <title>消息中心-览书网作者中心</title>
    <link rel="Shortcut Icon" href="../img/slogo.ico" >
    <link rel="stylesheet" href="../css/author.css"/>
    <link rel="stylesheet" href="../css/authorMessage.css"/>
...
<article class="auto">
    ...
    <div class="side">
        <ul>
            ...
            <li class="message current"><h4><em></em><a href="authorMessage.jsp">消息中心</a></h4></li>
        </ul>
    </div>
    <div class="main">
        <div class="content">
...
<script src="../js/authorMessage.js"></script>
</body>
</html>